    ...
    <main className="min-h-screen">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Leverage AI to generate content and structure for your PRDs</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Export your PRDs as PDF, Markdown, or integrate with coding tools</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Access a variety of templates to kickstart your projects</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-20">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold mb-4">Ready to Streamline Your Project Requirements?</h2>
          <p className="text-lg text-gray-600 mb-8">
      ...
      <footer className="bg-gray-900 text-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">PRD Creator</h3>
              <p className="text-gray-400">
                Empowering indie hackers and solopreneurs to create efficient Project Requirement Documents.
              </p>
            </div>
            <div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
            <p> 2024 PRD Creator. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </main>
